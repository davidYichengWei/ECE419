...
/**
 * Entry point to the storage server that accepts client connection requests.
 * This is the communication module of the storage server.
 * The server starts a new thread for each client connection.
 */
